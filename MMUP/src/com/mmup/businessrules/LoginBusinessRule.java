package com.mmup.businessrules;
...
import com.mmup.util.DBConnection;
...
public class LoginBusinessRule {
...

	{
		...
		String isUserExist = "SELECT * from MMUP_USER_MASTER where USERNAME =  '" + login + "' and PASSWORD = '" + password + "' ";
